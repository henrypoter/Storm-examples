...
public class DiagnoisisEventEmitter implements Emitter<Long>, Serializable {

	private static  final long serialVersionUID=1L;
	AtomicInteger successfulTransactons=new AtomicInteger(0);
	...
	public void success(TransactionAttempt tx) {
		successfulTransactons.incrementAndGet();
	}
